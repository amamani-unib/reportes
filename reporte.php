              ...
              <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <select name="repo" id="repo" class="form-control" required onchange="ver_div();">
                      ...
                      <option value="sinistros_liquidados_au_unisersoft_completo">Siniestros liquidados automovil -
                        Sistema Unisersoft Completo</option>
                      <option value="sinistros_liquidados_otros_completo">Siniestros liquidados otros - Sistema
                        Unisersoft Completo</option>
                      ...
                      <option value="correspodencia_cite_hoja_log">Correspondencia - Hojas de ruta - derivaciones
                      </option>
                      ...
                      <?php
                        ...
                        if ($tipo_usuario == 'admin' or $tipo_usuario == 'GERENTE GENERAL' or $tipo_usuario == 'RECEPCIONISTA') {
                          ?>
                      <option value="constancia_documentos_recepcion">Constancia de entrega de documentos por recepción
                      </option>
                      <?php
                        }
                        if (
                      ...
                      <?php
                        ...
                        if ($tipo_usuario == 'admin' or $tipo_usuario == 'GERENTE GENERAL' or $tipo_usuario == 'ESTADISTICA' or $tipo_usuario == 'AUDITORIA') {
                          ?>
                      <option value="comercial_especifico">Reporte Comercial Diario / Semanal (Sistema Unibienes)
                      </option>
                      <?php
                        }
                        if (
                      ...
                      <option value="pagos_anticipados_ot">Siniestros - Pago Anticipos - Ordenes Trabajo/Compra Sistema
                        Unisersoft</option>
                      <?php
                        }
                        if ($tipo_usuario == 'admin' or $tipo_usuario == 'GERENTE GENERAL' or $tipo_usuario == 'UIF' or $tipo_usuario == 'AUDITORIA') {
                ...
                <div id="div_fechas" style="display: none;">
                  <div class='form-check col-md-12 col-xs-12'>
                    <input class='form-check-input' type='checkbox' name='cb_lapso' id='cb_lapso'
                      onchange="fechas_selec(this);">
