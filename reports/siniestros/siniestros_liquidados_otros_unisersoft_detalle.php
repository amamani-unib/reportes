...
if (!isset($_POST['cb_lapso'])) {
    ...
    $titulo = "VISTA PREVIA DE SINIESTROS LIQUIDADOS OTROS RAMOS (Sisitema Unisersoft) - ORDEN TRABAJO-COMPRA. DEL $fecha_dia";
} else {
    ...
    $titulo = "VISTA PREVIA DE SINIESTROS LIQUIDADOS OTROS RAMOS (Sisitema Unisersoft) - ORDEN TRABAJO-COMPRA. DESDE $fecha_inicio HASTA $fecha_final";
}
