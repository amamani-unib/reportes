<?php
$consulta = "SELECT rc.modalidad_ramo,rc.cia,pc.lugar,rc.modalidad,rc.cod_poliza,pc.cambio,pc.movimiento,pc.id_calculo_prima,
    ...
    <table class='tabla_datos table-striped table-bordered table table-hover' cellspacing='0' width='100%'
        ...
        <thead>
            <tr class='text-center'>
                ...
                <th>Codigo Sector</th>
                <th>Moneda</th>
                <th>Fecha efectiva del movimiento</th>
                <th>Codigo de modalidad</th>
                <th>Codigo de ramo</th>
                <th>Número póliza/contrato</th>
                <th>Tipo de cambio/cotización aplicado</th>
                <th>Tipo de operación</th>
                <th>Monto capital asegurado/Tarifa Anticipada BS</th>
                <th>Poliza nueva emitida/contrato nuevo emitido</th>
                <th>Póliza renovada/contrato renovado</th>
                <th>Prima Directa/ Tarifa Anticipada</th>
                <th>Prima Directa / Tarifa Ancipada BS</th>
                <th>Capital Anulado</th>
                <th>Poliza anulada/contrato anulado</th>
                <th>Prima anulada / tarifa anulada</th>
                <th>Prima anulada / Tarifa Anticipada anulada BS</th>
                <th>Captital Asegurado Neto BS</th>
                <th>Polizas Netas anuladas / Contratos netos Anulados</th>
                <th>Prima Neta Anulada/Tarifa Anticipada Neta Anulada</th>
                <th>Prima Neta Anulada / Tarifa Anticipada Neta Anulada Bs.</th>
                <th>Prima Aceptada en Reaseguro / Tarifa Anticipada Aceptada en Reaseguro</th>
                <th>Prima Aceptada en Reaseguro / Tarifa Anticipada Cedida en Reaseguro Bs</th>
                <th>Prima Cedida en Reaseguro/ Tarifa Anticipada Cedida en Reaseguro</th>
                <th>Prima Cedida en Reaseguro/ Tarifa Anticipada Cedida en Reaseguro Bs.</th>
                <th>Anulación de Primas Cedidas en Reaseguro/Anulación Tarifas Anticipadas Cedidas en reaseguro</th>
                <th>Anulación de Primas Cedidas en Reaseguro/Anulación Tarifas Anticipadas Cedidas en reaseguro Bs.</th>
            </tr>
        </thead>
        <tbody>
            <?php
